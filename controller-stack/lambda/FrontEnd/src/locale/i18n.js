...
const resources = {
	'en-US': {
		translation: {
			...
			"Language": "EN",
			"Manual": "User Manual",
			"ManualLink": "https://www.amazonaws.cn/en/getting-started/tutorials/create-ssl-with-cloudfront/",
			"Match": "match",
			"Matches": "matches",
			"Modify": "Modify",
	...
	'zh-CN': {
		translation: {
			...
			"Language": "ZH",
			"Manual": "用户手册",
			"ManualLink":"https://www.amazonaws.cn/getting-started/tutorials/create-ssl-with-cloudfront/",
			"Match": "个匹配",
			"Matches": "个匹配",
			"Modify": "修改",
			"ModifyProject": "修改项目",
